...
function Login() {
  ...
  return (
    <div className="login pt-4 px-2 xs:px-14 sm:px-32 md:px-52 lg:px-68 xl:px-110 2xl:px-120 bg-white select-none" style={{height: "89vh"}}>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-white xs:border-gray-300 py-4 px-6 sm:px-8 xl:px-10 rounded-sm">
            <h1 className="mt-3 text-gray-700 text-3xl font-bold tracking-wide">Sign-In</h1>
        ...
        <p className="mt-2 text-xs text-gray-700 text-center">__________new to amazon?__________</p>
        <Link to="/register" className="inline-block text-center w-full mt-2 px-4 py-1 text-gray-700 bg-gradient-to-t from-gray-300 focus:from-gray-400 tracking-wider text-sm border border-gray-500 focus:border-gray-100 focus:outline-none focus:ring-2 ring-gray-400 rounded-sm">
            Create New Account
        </Link>
