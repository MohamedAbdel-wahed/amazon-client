...
function LandingSlider() {
 ...
 return (
  <div className="landing__slider z-10 flex w-full h-40 xs:h-56 sm:h-76 md:h-96 lg:h-108 xl:h-116 2xl:h-124 -mb-14 xs:-mb-24 sm:-mb-36 md:-mb-48 lg:-mb-56 xl:-mb-72">
